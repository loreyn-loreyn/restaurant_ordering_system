<div class="flex flex-col h-full relative">
    ...
    <div class="flex items-center gap-3 px-6 py-3 border-b bg-white shrink-0">
        ...
        <span class="text-lg font-semibold text-slate-800">New Staff Info</span>
    </div>
    ...
    <div class="flex-1 overflow-y-auto p-6">
        <div class="max-w-3xl">
            ...
            <div class="flex items-center gap-4 mb-6">
                <div class="w-24 h-24 rounded bg-slate-200 flex items-center justify-center overflow-hidden shrink-0 text-3xl text-slate-400">
                    @if ($Photo)
                ...
                <div>
                    <input type="file" wire:model="Photo" accept="image/*"
                           class="block text-xs text-slate-500 file:mr-3 file:py-1.5 file:px-3 file:rounded-full file:border-0 file:bg-slate-100 file:text-slate-600 file:text-xs">
